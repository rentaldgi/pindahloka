            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-[94%] items-center mx-auto">
              {currentArticles.map((article) => (
                <Link href={`/artikel/${article.slug}`} key={article.id}>
                  <div className="bg-white rounded-xl overflow-hidden hover:shadow-xl transition-shadow duration-300 shadow-md flex flex-col h-80 border-2 border-gray-200">
